...
def main():
    ...
    ax1.hist(life_exp1950, bins=30)
    ax1.set_xlabel("Life Expectancy [in years]")
    ax1.set_ylabel("Frequency")
    ax1.set_title("1950")

    ax2.hist(life_exp2007, bins=30)
    ax2.set_xlabel("Life Expectancy [in years]")
    ax2.set_title("2007")

    plt.show()

    g, (ax3, ax4) = plt.subplots(nrows=1, ncols=2, sharey=True)
    g.suptitle("Life Expectancy Distribution [1950 vs. 2007]")

    sns.histplot(life_exp1950, bins=30, ax=ax3, kde=True)
    ax3.set_xlabel("Life Expectancy [in years]")
    ax3.set_ylabel("Frequency")
    ax3.set_title("1950")

    sns.histplot(life_exp2007, bins=30, ax=ax4, kde=True)
    ax4.set_xlabel("Life Expectancy [in years]")
    ax4.set_title("2007")

    plt.show()

    # people live significantly longer in 2007 compared to 1950
    # the graphic shifted to the right
