...
def insert_overview_img(workbook, overview_img_path):
...
def main():
    ...
    # data_audit - https://docs.google.com/spreadsheets/d/1-L0Mr5fLIdWaw_goEwMIkPqV0z3W39tRdiYQexurdFw/edit?usp=sharing
