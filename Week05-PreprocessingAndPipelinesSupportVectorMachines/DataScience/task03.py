...
def insert_imgs(workbook, overview_img_path):
    workbook["overview"].add_image(Image(overview_img_path), "A30")
...
def create_dataset(path):
    ...
    if 'genre' in df.columns:
        rock_col = (df['genre'] == 'Rock').astype(int)
...
def main():
    ...
    # data_audit - https://docs.google.com/spreadsheets/d/1t_n9U5STmFLpx2pxpBmc-p2vSri3HRVMkk-4goK5GWA/edit?usp=sharing
