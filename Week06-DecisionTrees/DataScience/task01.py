...
def insert_imgs(workbook, overview_img_path):
    workbook["overview"].add_image(Image(overview_img_path), "A40")
...
def main():
    ...
    #data_audit - https://docs.google.com/spreadsheets/d/1PymY3Waq4KrLWjEMPhCjyYshkFVTtqrznPybKAknGnM/edit?usp=sharing
