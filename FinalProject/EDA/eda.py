...
DATASET_PATH = os.path.join("..", "DATA", "distributed_system_architecture_stress_dataset.csv")
OUTPUT_XLSX = "data_audit.xlsx"
ASSETS_DIR = "assets"
TARGET = "system_state"
CATEGORICAL_FEATURES = ["architecture_type", "deployment_type", "communication_type", "root_cause"]
...
def insert_imgs(workbook, overview_img_path):
    workbook["overview"].add_image(Image(overview_img_path), "A15")
...
def main():
    ...
    insert_imgs(workbook, overview_img_path)
